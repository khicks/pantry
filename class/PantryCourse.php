...
class PantryCourse {
    ...
    public function save() {
        if ($this->id) {
            ...
            $sql_save_course = Pantry::$db->prepare("INSERT INTO courses (id, created, title, slug) VALUES (:id, :created, :title, :slug)");
            $sql_save_course->bindValue(':created', Pantry::getNow(), PDO::PARAM_STR);
        }
