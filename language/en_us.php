...
return [
    ...
    'INSTALL_DATABASE_TYPE' => "Type",
    'INSTALL_DATABASE_PORT' => "Port",
    'INSTALL_DATABASE_HOST' => "Host",
    'INSTALL_DATABASE_DATABASE' => "Database",
    'INSTALL_DATABASE_PATH_DESC' => "Your database will be stored at the following path in your Pantry directory:",
    ...
    'INSTALL_DATABASE_TYPES_SUCCESS' => "Here are the supported database types.",
    ...
    'INSTALL_ERROR_DB_NONE' => "No supported backend databases were found.",
    'INSTALL_ERROR_DB_TYPE_NOT_FOUND' => "Database type was not recognized.",
    ...
    'UPDATE_FAILED_UNKNOWN' => "Update failed due to an unknown error.",
